...
class Sb3VecEnvGPUWrapper(VecEnv):
    ...
    def _process_obs(self, obs_dict: torch.Tensor | dict[str, torch.Tensor]) -> torch.Tensor | dict[str, torch.Tensor]:
...
class L2tSb3VecEnvGPUWrapper(Sb3VecEnvGPUWrapper):
    ...
    ) -> torch.Tensor | dict[str, torch.Tensor] | dict[str, torch.Tensor | dict[str, torch.Tensor]]:
        """Do nothing."""
